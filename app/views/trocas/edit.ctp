...
<div class="botoes">
	...
	<?php echo $html->link('Excluir Troca', array('action' => 'delete', $form->value('Troca.id')), array('class'=>'btn_azul floatRight mgr5'), sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Troca.id'))); ?>
</div>
