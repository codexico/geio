<ul>
    ...
    <ul class="relatorios">
        ...
        <li><?php echo $html->link(__('Trocas de Ontem', true), array('action' => 'ontem', 'controller'=>'trocas')); ?> </li>
        <li><?php echo $html->link(__('Trocas de Semana', true), array('action' => 'semana', 'controller'=>'trocas')); ?> </li>
        <li><?php echo $html->link(__('Trocas de Mês', true), array('action' => 'mes', 'controller'=>'trocas')); ?> </li>
    </ul>
    <br />
